...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${mulish.variable} ${inter.variable}`}>
      <head>
        <link rel="apple-touch-icon" sizes="180x180" href="lumozionew/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="lumozionew/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="lumozionew/favicon-16x16.png">
        <link rel="manifest" href="lumozionew/site.webmanifest">
      </head>
